...
public class HomePage extends Base {
    ...
    public static final String ACTUAL_RESULT_DATE = "MONDAY, APRIL 11, 2022 AT 12:00 AM PDT";
    public static final String NEW_EVENT_NAME = "Edited name";
    public static final String NEW_DESCRIPTION = "New Description";
    public static final String NEW_EVENT_TYPE = "Online event";
    ...
    public void createEvent() throws InterruptedException, IOException {
        ...
        public void EditPage() throws InterruptedException {
            ...
            String actualResult = driver.findElement(By.xpath("(//span[@class = 'a8c37x1j ni8dbmo4 stjgntxs l9j0dhe7 ltmttdrg g0qnabr5 ojkyduve'])[7]")).getText();
            Assert.assertEquals(actualResult, NEW_EVENT_TYPE);
    }
}
